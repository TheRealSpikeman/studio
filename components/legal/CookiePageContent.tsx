    ...
    return (
        <>
            ...
            <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                ...
                <Section icon={Info} value="item-1">
                    <SubSection>
                ...
                <Section icon={ShieldCheck} value="item-3">
                    <SubSection>
                ...
                <Section icon={Globe} value="item-4">
                ...
                <Section icon={UserCog} value="item-5">
                    <SubSection>
                ...
                <Section icon={BarChart2} value="item-6">
                     <SubSection>
                         <ul className="list-none space-y-2 pl-0">
                ...
                <Section icon={Gavel} value="item-7">
                     <SubSection>
