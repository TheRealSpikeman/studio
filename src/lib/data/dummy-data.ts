...
// From admin/user-management/page.tsx
export const DUMMY_USERS: User[] = [
  ...
  { id: 'parent2', name: 'Pieter Papa', email: 'pieter.papa@example.com', status: 'actief', role: 'ouder', lastLogin: new Date(Date.now() - 86400000 * 4).toISOString(), createdAt: new Date(Date.now() - 86400000 * 60).toISOString(), children: ['child2_of_pieter'] },
  { id: 'child2_of_pieter', name: 'Milo Papa (Kind)', email: 'milo.kind@example.com', status: 'actief', role: 'leerling', ageGroup: '15-18', parentId: 'parent2', lastLogin: new Date(Date.now() - 86400000 * 3).toISOString(), createdAt: new Date(Date.now() - 86400000 * 55).toISOString() },
...
export const DUMMY_TUTORS: User[] = [
  { id: 't1', name: 'Dr. Anna Visser', email: 'anna.visser@example.com', status: 'actief', role: 'tutor', lastLogin: new Date(Date.now() - 86400000 * 1).toISOString(), createdAt: new Date(Date.now() - 86400000 * 90).toISOString(), avatarUrl: 'https://picsum.photos/seed/annavisser/40/40', tutorDetails: { subjects: ['Wiskunde', 'Natuurkunde'], hourlyRate: 35, bio: "Ervaren docent met passie voor exacte vakken.", availability: "Ma, Wo, Vr avond", totalRevenue: 1250, averageRating: 4.8 } },
