...
export const DUMMY_USERS: User[] = [
  { id: 'ja3Zf9s15wVquYIB90GpesLwI', name: 'G. Bosch', email: 'g.bosch@mindnavigator.io', status: 'actief', role: 'admin', lastLogin: new Date(Date.now() - 86400000 * 1).toISOString(), createdAt: new Date(Date.now() - 86400000 * 30).toISOString(), avatarUrl: 'https://picsum.photos/seed/glenna/40/40' },
  ...
  { id: 'coach1', name: 'Edward Coachman', email: 'edward.coach@coach-circle.net', status: 'actief', role: 'coach', lastLogin: new Date(Date.now() - 86400000 * 1).toISOString(), createdAt: new Date(Date.now() - 86400000 * 10).toISOString(), avatarUrl: 'https://picsum.photos/seed/edwardc/40/40', coaching: { startDate: new Date(Date.now() - 86400000 * 5).toISOString(), interval: 1, currentDayInFlow: 5 } },
