      ...
      items: [
        {
          ...
          progress: ["Week 1: Geprobeerd", "Week 2: Aangepast naar wat werkt", "Week 3: Routine gevonden", "Week 4: Geëvalueerd en verfijnd"]
        },
        {
        ...
        <div className="bg-white text-black font-sans">
            ...
            <main className="p-8 md:p-12 lg:p-16 max-w-4xl mx-auto print-main">
                <div className="text-center mb-10 print-avoid-break">
                    <div className="w-24 h-24 mx-auto mb-4 relative bg-gray-200 rounded-full flex items-center justify-center">
                        <Image src="https://placehold.co/100x100.png" alt="Gezinsfoto" layout="fill" className="rounded-full object-cover border-4 border-primary/20" data-ai-hint="family photo" />
                    </div>
