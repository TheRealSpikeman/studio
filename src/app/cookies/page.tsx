        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-base leading-relaxed text-foreground/90">
            ...
            <section id="wat-zijn-cookies" className="space-y-4">
              <h2 className="text-2xl font-semibold text-primary mb-4">1. Wat zijn cookies?</h2>
            ...
            <section id="hoe-gebruiken-wij-cookies" className="space-y-4">
              <h2 className="text-2xl font-semibold text-primary mb-4">2. Hoe gebruiken wij cookies?</h2>
            ...
            <section id="uw-keuzes" className="space-y-4">
              <h2 className="text-2xl font-semibold text-primary mb-4">3. Uw keuzes met betrekking tot cookies</h2>
            ...
            <section id="cookies-van-derden" className="space-y-4">
              <h2 className="text-2xl font-semibold text-primary mb-4">4. Cookies van derden</h2>
            ...
            <section id="wijzigingen-cookiebeleid" className="space-y-4">
              <h2 className="text-2xl font-semibold text-primary mb-4">5. Wijzigingen in dit cookiebeleid</h2>
