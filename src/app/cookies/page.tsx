  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center py-12 md:py-16 lg:py-20">
        <div className="container max-w-3xl"> {/* Max-width toegevoegd voor leesbaarheid */}
          <h1 className="text-3xl font-bold text-foreground mb-2">Cookiebeleid</h1>
          <p className="text-sm text-muted-foreground mb-8">Laatst bijgewerkt: {new Date().toLocaleDateString('nl-NL')}</p>
          ...
          <hr className="my-8 border-border" /> {/* Meer marge voor hr */}

          <section id="wat-zijn-cookies" className="space-y-4"> {/* Meer marge voor secties */}
          ...
          <div className="mt-10 p-6 border rounded-lg bg-primary/10"> {/* Aangepaste padding */}
              <h3 className="text-lg font-semibold text-primary mb-2">Cookievoorkeuren Beheren</h3>
              <p className="text-sm text-foreground/80 leading-relaxed"> {/* Aangepaste text color */}
              ...
              {/* 
              <Button variant="outline" className="mt-4" disabled> // Aangepaste margin-top
