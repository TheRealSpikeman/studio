...
const generalFaqs = [
  ...
  },
  {
    ...
    answer: "Privacy en veiligheid zijn voor ons van het grootste belang. We behandelen alle persoonlijke gegevens vertrouwelijk en conform de AVG/GDPR-richtlijnen. Resultaten van zelfreflectie-instrumenten zijn persoonlijk en worden niet zonder toestemming gedeeld. Voor betaalde abonnementen voor minderjarigen is altijd ouderlijke toestemming en betaling vereist. Voor gedetailleerde informatie verwijzen we u naar ons <a href='/privacy' class='text-primary hover:underline font-medium'>Privacybeleid <ExternalLink class='inline-block h-4 w-4 align-text-bottom'/></a>.",
