...
import { SiteLogo } from '@/components/common/site-logo'; // Assuming dashboard layout might not show this, but standalone welcome could

// Dummy user data - in a real app, this would come from context/auth
const currentUser = {
  name: "Alex", // Replace with actual user name
  ageGroup: "15-18" as "12-14" | "15-18" | "adult", // Replace/derive actual age group
};
...
export default function LeerlingWelcomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
      {/* Optional: SiteLogo if this page is outside the main dashboard layout initially */}
      {/* <div className="absolute top-8 left-8"> <SiteLogo /> </div> */}
      ...
      <Card className="w-full max-w-2xl shadow-xl text-center">
        ...
        <CardContent className="space-y-8 px-8 py-6">
          ...
          <div className="p-6 bg-primary/10 rounded-lg border border-primary/30 text-left">
