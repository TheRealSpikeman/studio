...
const flowSteps = [
    ...
    },
    {
        step: 2,
        icon: BrainCircuit,
        title: "Flow 1: `generateQuizAnalysis`",
        ...
        details: [
            ...
            "Identificeert sterktes, aandachtspunten en geeft algemene tips.",
            "De output is een gestructureerde lap tekst (Markdown), de 'onboardingAnalysisText'."
        ]
    },
    {
        step: 3,
    ...
    },
     {
        step: 4,
        icon: Sparkles,
        title: "Flow 2: `generateCoachingInsights`",
