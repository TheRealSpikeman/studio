...
// This is the original, detailed CV-style page for the primary AI persona.
export default function AiPersonaDocumentationPage() {
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-foreground flex items-center gap-3">
            ...
            AI Persona Profiel & Documentatie
          </h1>
