// src/app/dashboard/admin/quiz-management/new/manual/page.tsx
"use client";
...
import { PlusCircle, Trash2, ArrowLeft, Save, Eye, ListChecks, Settings, Info, Weight, ImageUp, Edit } from "lucide-react";
...
export default function ManualNewQuizPage({ quizData }: QuizFormPageProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold text-foreground flex items-center gap-2">
                ...
                {isEditMode ? 'Quiz Bewerken' : 'Nieuwe Quiz (Handmatig)'}
            </h1>
