...
interface CoachingSession { // Renamed from Lesson
  id: string;
  clientId: string; 
  clientName: string; // Renamed from studentName
  clientAvatar?: string; // Renamed from studentAvatar
  sessionTopic: string; // Renamed from subject
  dateTime: string; 
...
const dummyUpcomingSessions: CoachingSession[] = [
...
const dummyPastSessions: CoachingSession[] = [
...
export default function CoachSessionsPage() {
  ...
  const [sessions, setSessions] = useState<{upcoming: CoachingSession[], past: CoachingSession[]}>({upcoming: dummyUpcomingSessions, past: dummyPastSessions});
