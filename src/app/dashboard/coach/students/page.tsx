...
interface ClientEntry { // Renamed from StudentEntry
  ...
  name: string;
  avatarUrl?: string;
  coachingFocusAreas: string[]; // Renamed from subjectsTaughtByTutor
  lastSessionDate?: string; // Renamed from lastLessonDate
  totalSessionsWithCoach?: number; // Renamed from totalLessonsWithTutor
}
