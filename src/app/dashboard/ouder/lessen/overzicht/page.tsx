// src/app/dashboard/ouder/lessen/overzicht/page.tsx
"use client";
  ...
  return (
    <div className="overflow-x-auto">
      <Table>
        ...
        <TableBody>
          {lessons.length === 0 && (
            <TableRow><TableCell colSpan={8} className="h-24 text-center">Nog geen lessen in deze categorie.</TableCell></TableRow>
          )}
          {lessons.map((lesson) => (
...
export default function OverzichtLessenPage() {
  ...
  const completedLessons = useMemo(() => 
    scheduledLessons.filter(l => l.status === 'Voltooid').sort((a,b) => parseISO(b.dateTime).getTime() - parseISO(a.dateTime).getTime()), 
    [scheduledLessons]
  );
  const cancelledLessons = useMemo(() => 
    scheduledLessons.filter(l => l.status === 'Geannuleerd').sort((a,b) => parseISO(b.dateTime).getTime() - parseISO(a.dateTime).getTime()), 
    [scheduledLessons]
  );
        ...
        <CardContent>
          <Tabs defaultValue="upcoming">
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="completed">Voltooid ({completedLessons.length})</TabsTrigger>
              <TabsTrigger value="cancelled">Geannuleerd ({cancelledLessons.length})</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="completed" className="mt-4">
              <LessonTable lessons={completedLessons} onCancelLesson={handleCancelLessonClick} onMarkAsCompleted={markAsCompleted} onViewReport={handleViewReport} />
            </TabsContent>
            <TabsContent value="cancelled" className="mt-4">
              <LessonTable lessons={cancelledLessons} onCancelLesson={handleCancelLessonClick} onMarkAsCompleted={markAsCompleted} onViewReport={handleViewReport} />
            </TabsContent>
          </Tabs>
        </CardContent>
      </Card>
