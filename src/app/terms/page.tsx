          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-6"> 
              ...
              <section id="zelfreflectie-instrumenten-resultaten" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">4. Zelfreflectie-instrumenten en Inzichten</h2>
              ...
              <section id="abonnementen-betalingen" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">6. Abonnementen en Betalingen</h2>
              ...
              <section id="beperking-aansprakelijkheid" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">7. Beperking van Aansprakelijkheid</h2>
              ...
              <section id="wijzigingen-voorwaarden" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">8. Wijzigingen in de Voorwaarden</h2>
              ...
              <section id="toepasselijk-recht" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">9. Toepasselijk recht en Geschillen</h2>
