        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-10 text-base leading-relaxed text-foreground/90">
            <section id="toepasselijkheid" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">1. Toepasselijkheid</h2>
            ...
            <section id="gebruik-dienst" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">2. Gebruik van de Dienst</h2>
            ...
            <section id="intellectueel-eigendom" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">3. Intellectueel Eigendom</h2>
            ...
            <section id="zelfreflectie-instrumenten-resultaten" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">4. Zelfreflectie-instrumenten en Inzichten</h2>
            ...
            <section id="genai-features" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">5. GenAI Features</h2>
            ...
            <section id="abonnementen-betalingen" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">6. Abonnementen en Betalingen</h2>
            ...
            <section id="beperking-aansprakelijkheid" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">7. Beperking van Aansprakelijkheid</h2>
            ...
            <section id="wijzigingen-voorwaarden" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">8. Wijzigingen in de Voorwaarden</h2>
            ...
            <section id="toepasselijk-recht" className="space-y-3">
              <h2 className="text-2xl font-semibold text-primary mb-4">9. Toepasselijk recht en Geschillen</h2>
