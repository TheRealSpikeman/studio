        ...
        <div className="container">
          <Card className="shadow-lg">
            ...
            <CardContent className="prose max-w-none dark:prose-invert">
              ...
              <p>Deze algemene voorwaarden zijn van toepassing op elk gebruik van de website en diensten van MindNavigator (hierna "de Dienst"). Door gebruik te maken van de Dienst, aanvaardt u deze voorwaarden.</p>
              ...
              <p>MindNavigator is niet aansprakelijk voor enige directe, indirecte, incidentele, gevolg- of speciale schade die voortvloeit uit of verband houdt met uw gebruik van de Dienst of de onmogelijkheid om de Dienst te gebruiken, zelfs als wij op de hoogte zijn gesteld van de mogelijkheid van dergelijke schade.</p>
