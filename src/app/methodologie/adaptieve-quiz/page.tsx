// src/app/methodologie/adaptieve-quiz/page.tsx
"use client";
...
import { GitBranch, Target, ClipboardList, Bot, ShieldCheck, AlertTriangle, ArrowRight } from 'lucide-react';
      ...
      <main className="flex-1 bg-gradient-to-b from-background via-secondary/10 to-background py-12 md:py-20 lg:py-28">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-10 text-base leading-relaxed text-foreground/90">
            ...
            <Alert variant="destructive" className="p-6 rounded-lg">
                <AlertTriangle className="h-6 w-6" />
                <AlertTitleUi className="text-xl font-bold">Essentiële Disclaimer: Geen Diagnostisch Instrument</AlertTitleUi>
