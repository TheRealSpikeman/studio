          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-6"> 
              ...
              <section id="uw-rechten" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">6. Uw rechten (AVG/GDPR)</h2>
              ...
              <section id="bewaartermijnen" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">7. Bewaartermijnen</h2>
              ...
              <section id="wijzigingen-privacybeleid" className="space-y-3">
                <h2 className="text-2xl font-semibold text-foreground">9. Wijzigingen in dit privacybeleid</h2>
