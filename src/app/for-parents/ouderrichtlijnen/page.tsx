...
import {
    ...
    Download, List, Brain, Zap, BookOpenCheck, GraduationCap, MessageSquareText, CheckCircle, XCircle
} from '@/lib/icons';
        ...
        <div className="space-y-12">
            ...
            <GuidelineSection id="wat-is-mindnavigator" title="Wat is MindNavigator? - Voor Ouders Uitgelegd" icon={Target}>
                <div className="grid md:grid-cols-2 gap-6">
                    <SubSectionCard title="Wat MindNavigator WEL Is" icon={CheckCircle}>
            ...
            <GuidelineSection id="privacy-autonomie-balans" title="Privacy & Autonomie Balans" icon={ShieldCheck}>
                <div className="grid md:grid-cols-2 gap-6">
                    <SubSectionCard title="Wat Ziet U Wel?" icon={CheckCircle}>
