...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-muted hover:text-primary focus-visible:ring-2 active:bg-muted/80 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-muted data-[active=true]:font-semibold data-[active=true]:text-primary data-[state=open]:bg-muted data-[state=open]:text-primary group-data-[collapsible=icon]:!size-9 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-0 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:group-data-[collapsible=icon]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "",
...
>(({ asChild = false, size = "sm", isActive, disabled, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-muted hover:text-primary focus-visible:ring-2 active:bg-muted/80 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
        "data-[active=true]:bg-muted data-[active=true]:text-primary data-[active=true]:font-semibold",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        disabled && "pointer-events-none opacity-50", // Visual cue for disabled
        className
      )}
      {...props}
    />
