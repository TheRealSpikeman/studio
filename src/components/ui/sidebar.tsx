      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper", // Removed flex and min-h-svh to fix layout issues
              className
            )}
            ref={ref}
            {...props}
...
>(({ asChild = false, size = "sm", isActive, disabled, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring transition-colors hover:text-primary focus-visible:ring-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
