                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                {allHomeworkSubjects.map((subject) => (
                                    <FormField
                                        ...
                                        name="helpSubjects"
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-center space-x-2 rounded-md border p-1">
                                                <FormControl>
                                                    <Checkbox
                                                ...
                                                <FormLabel className="text-sm font-normal pl-0">{subject.name}</FormLabel>
                                            </FormItem>
                                        )}
                                    />
                                ))}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-center space-x-2 rounded-md border p-1">
                                                ...
                                                <FormLabel className="text-sm font-normal pl-0">{opt.label}</FormLabel>
                                            </FormItem>
                                        )}
                                    />
                                ))}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-center space-x-2 rounded-md border p-1">
                                                ...
                                                <FormLabel className="text-sm font-normal pl-0">{doel.label}</FormLabel>
                                            </FormItem>
                                        )}
                                    />
                                ))}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="flex flex-row items-center space-x-2 rounded-md border p-1">
                                                ...
                                                <FormLabel className="text-sm font-normal pl-0">{pref.label}</FormLabel>
                                            </FormItem>
                                        )}
                                    />
                                ))}
