...
const plansData: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Toegang tot Tutors & Coaches', included: false, tooltip: "Deze functie is beschikbaar in het 'Gezins Gids' abonnement. U krijgt dan toegang tot een pool van externe professionals." },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Vind & Boek Persoonlijke Coaches', included: true, tooltip: "Krijg toegang tot een geselecteerde pool van coaches en psychologen. U kunt profielen bekijken en direct sessies boeken (aparte kosten per sessie)." },
      { text: 'Vind & Boek Huiswerktutors', included: true, tooltip: "Krijg toegang tot een geselecteerde pool van huiswerktutors. U kunt profielen bekijken en direct sessies boeken (aparte kosten per sessie)." },
