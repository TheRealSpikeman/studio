...
import { ExternalLink, ShieldCheck, FileText, AlertTriangle, Gavel } from 'lucide-react';
...
export const DisclaimerContent = () => (
    <div className="text-sm">
        ...
        <Section title="Raadpleeg Altijd een Professional" icon={AlertTriangle}>
        ...
        <Section title="Gebruik van AI-gegenereerde Content" icon={AlertTriangle}>
        ...
        <Section title="Beperking van Aansprakelijkheid" icon={AlertTriangle}>
