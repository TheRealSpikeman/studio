...
export const aiPersonas: AiPersona[] = [
  {
    ...
    contribution: 'Dr. Sage adviseert MindNavigator over de inhoudelijke juistheid van de zelfreflectie-instrumenten en de educatieve content, en helpt bij het waarborgen van een ethische en verantwoorde benadering.',
    linkedinUrl: '#',
