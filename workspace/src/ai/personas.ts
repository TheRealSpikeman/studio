...
export const aiPersonas: AiPersona[] = [
  {
    ...
    title: 'Internationaal Erkend Kinder- & Jeugdpsycholoog',
    imageUrl: 'https://placehold.co/200x200.png',
    imageHint: 'professional woman portrait',
    bio: 'Dr. Sage is een internationaal erkend psycholoog met meer dan 20 jaar ervaring. Ze is een veelgevraagd spreker op conferenties over neurodiversiteit en heeft diverse publicaties in toonaangevende wetenschappelijke tijdschriften op haar naam staan. Haar werk richt zich op het snijvlak van technologie en psychologie om toegankelijke ondersteuning te bieden.',
